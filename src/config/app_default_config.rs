...
impl AppDefaultState {
    pub fn new(block_size: usize, map_span: usize, map_start: usize, map_end: usize, blocks_before_truncate: usize, current_block: Option<MemoryUpdateType>) -> AppDefaultState {
        AppDefaultState {
            block_size,
            map_span,
            map_start,
