...
impl SampledMemoryUsagesFactory {
    ...
    pub fn divide_usages_into_buckets(&self) -> Vec<MemoryUsageSample> {
        ...
        let mut previous_averaged_usage = MemoryUsage::new(0, 0, (0, 0, 0), 0, 0, 0, 0);
...
mod tests {
    ...
    fn sample_one_update() {
        let memory_usages = vec![
            MemoryUsage::new(1, 1, (0, 0, 0), 1, 1, 0, 0),
        ];
    ...
    fn sample_multiple_updates_no_overlap() {
        let memory_usages = vec![
            MemoryUsage::new(1, 1, (1, 2, 1), 1, 1, 1, 0),
            MemoryUsage::new(2, 2, (2, 4, 2), 2, 2, 2, 0),
            MemoryUsage::new(3, 3, (3, 6, 3), 3, 3, 3, 0),
        ];
        let memory_usage_sampler = SampledMemoryUsagesFactory::new(1, memory_usages);
    ...
    fn sample_multiple_updates_overlap() {
        let memory_usages = vec![
            // timestamp = 1
            MemoryUsage::new(1, 1, (1, 2, 1), 1, 1, 1, 0),
            MemoryUsage::new(2, 2, (2, 4, 2), 2, 2, 1, 0),
            MemoryUsage::new(3, 3, (3, 6, 3), 3, 3, 1, 0),

            // timestamp = 2
            MemoryUsage::new(4, 4, (4, 8, 4), 4, 4, 2, 0),
            MemoryUsage::new(5, 5, (5, 10, 5), 5, 5, 2, 0),

            // timestamp = 3
            MemoryUsage::new(6, 6, (6, 12, 6), 6, 6, 3, 0),
        ];
    ...
    fn sample_multiple_updates_overlap_sample_interval_two() {
        let memory_usages = vec![
            ...
            MemoryUsage::new(4, 4, (4, 8, 4), 4, 4, 2, 0),
            MemoryUsage::new(5, 5, (5, 10, 5), 5, 5, 2, 0),
            MemoryUsage::new(6, 6, (6, 12, 6), 6, 6, 2, 0),

            // timestamp = 3
            MemoryUsage::new(7, 7, (7, 14, 7), 7, 7, 3, 0),
            MemoryUsage::new(8, 8, (8, 16, 8), 8, 8, 3, 0),
            MemoryUsage::new(9, 9, (9, 18, 9), 9, 9, 3, 0),

            // timestamp = 4
            MemoryUsage::new(10, 10, (10, 20, 10), 10, 10, 4, 0),
            MemoryUsage::new(11, 11, (11, 22, 11), 11, 11, 4, 0),
            MemoryUsage::new(12, 12, (12, 24, 12), 12, 12, 4, 0),

            // timestamp = 5
            MemoryUsage::new(13, 13, (13, 26, 13), 13, 13, 5, 0),
            MemoryUsage::new(14, 14, (14, 28, 14), 14, 14, 5, 0),
            MemoryUsage::new(15, 15, (15, 30, 15), 15, 15, 5, 0),

            // timestamp = 6
            MemoryUsage::new(16, 16, (16, 32, 16), 16, 16, 6, 0),
            MemoryUsage::new(17, 17, (17, 34, 17), 17, 17, 6, 0),
            MemoryUsage::new(18, 18, (18, 36, 18), 18, 18, 6, 0),
        ];
    ...
    fn real_log_test() {
        ...
        let memory_usage_stats = MemoryUsageFactory::new(memory_updates).calculate_usage_stats();
